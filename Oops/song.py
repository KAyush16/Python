...
#his function loads data from a text file, creates Artist, Album, and Song objects, 
# and builds the relationships between them.
def load_data():
    new_artist = None
    new_album = None
    artist_list = []
...
###############################################################################################################
        # new artist 
            if new_artist is None:
                ...
                # We've just read details for a new artist(we are adding new artist name here)
